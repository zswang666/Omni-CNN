...
if __name__ == '__main__':
        ...
        with open(gather_path) as f:
            ...
            for line in f:
                if first_line:
                    ...
                    room_id = image_info[1]
                    position = [image_info[2], image_info[3], image_info[4]]
                    angle = [image_info[5], image_info[6], image_info[7]]
    ...
    f_train.write("image_id room_id pos_x pos_y pos_z ang_x ang_y ang_z image_subpath\n")
    f_test.write("image_id room_id pos_x pos_y pos_z ang_x ang_y ang_z image_subpath\n")
    for index in range(len(room_id_list)):
        ...
        if room_id in test_room_id_list:
            ...
            f_test.write('{} {} {} {} {} {} {} {} {}\n'.format(test_image_id, room_id, position[0], position[1], position[2],
                    angle[0], angle[1], angle[2], image_subpath))
            test_image_id += 1
        else:
            # this belongs to train
            f_train.write('{} {} {} {} {} {} {} {} {}\n'.format(train_image_id, room_id, position[0], position[1], position[2],
                    angle[0], angle[1], angle[2], image_subpath))
            train_image_id += 1
    f_train.close()
    f_test.close()
