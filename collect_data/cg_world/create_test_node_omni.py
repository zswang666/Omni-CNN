...
"""
This file collects images and save it as a collection file, this file is for node and omni-directional camera
...
saved sampling file name will be: 'Scene_0_1-node-omni.txt' and will locate in root directory
...
if __name__ == '__main__':
    ...
    sampling_filename = scene_setting_name + '_gather-node-omni.txt'
