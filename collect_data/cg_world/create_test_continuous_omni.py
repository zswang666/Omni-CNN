...
"""
This file collects images and save it as a collection file, this file is for continuous and omni-directional camera
...
saved sampling file name will be: 'Scene_0_1-continuous-omni.txt' and will locate in root directory
...
if __name__ == '__main__':
    root_dir = raw_input('>>> Final test root directory (enter "d" to use default: /home/joehuang/Desktop/room_data_continuous_omni): ')
    if root_dir == 'd':
        root_dir = '/home/joehuang/Desktop/room_data_continuous_omni'
    ...
    sampling_count = int(raw_input('>>> how many points you want to sample in each collected point? (suggesting: 5): '))
    sigma_xy = float(raw_input('>>> what is the sampling range in unity unit you want to sample? (suggesting: 0.2): '))

    scene_setting_name = scene_name + '_' + str(setting_id)
    sampling_filename = scene_setting_name + '_gather-continuous-omni.txt'
    ...
    raw_input('>>> warning: you should be expecting to collect omni-directional image and using continuous sampling style in this file, press any key to continue')
    ...
    for sampling_index in range(len(node_ids)):
        ...
        for _ in range(sampling_count):
            ...
            try:
                ...
                con.setRot(angle[0], theta, angle[2])
                ...
                if (position[1] - sample_position[1]) >= 0.001:
                    ...
                    image_filename = str(image_count) + '.jpg'
    ...
    with open(sampling_path, 'w') as f:
        ...
        for index in range(len(image_id_list)):
            ...
            f.write('{} {} {} {} {} {} {} {} {}\n'.format(image_id, room_id, position[0], position[1], position[2],
